...
const CommodityManagement = () => import('@/pages/CommodityManagement'); // 商品管理
const CommodityAdd = () => import('@/pages/CommodityAdd'); // 添加商品
...
const router = new Router({
    ...
    routes: [
        ...
        { path: '/management', name: 'Management', component: CommodityManagement, meta: { index: 21 } }, // 商品管理
        { path: '/addManagement', name: 'AddManagement', component: CommodityAdd, meta: { index: 22 } }, // 添加商品
        { path: '*', redirect: { name: 'Home' } }
    ]
});
