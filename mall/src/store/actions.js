...
//设置购物车列表
const setShoppingCartList = ({ commit }, shoppingCartList) => {
    commit(types.SHOPPING_CART_LIST, shoppingCartListCache.setCache(shoppingCartList));
}
// 更新购物车列表
const updateShoppingCartList = ({ commit }, shoppingCartList) => {
    commit(types.SHOPPING_CART_LIST, shoppingCartListCache.updateCache(shoppingCartList));
}
// 删除购物车列表
const deleteShoppingCartList = ({ commit }) => {
    commit(types.SHOPPING_CART_LIST, shoppingCartListCache.deleteCache());
};
...
export default {
    ...
    setShoppingCartList,// 新增购物车
    updateShoppingCartList, //更新购物车
    deleteShoppingCartList // 删除购物车
};